...
const Imageurl = ({ handleImageChange, handleChange, newrecipe, selected_user_id, img_url, handleSubmit, handlecancel }) => {
    ...
    const add_recipe = (e) => {
        ...
        if (img_url !== null && newrecipe !== "") {
            newrecipe.image_url = img_url;
            const recipeDocRef = doc(db, "/Users/s48rdKPmfuUcQLBxHpnP91U6MG02/recipes", uuid);
            setDoc(recipeDocRef, newrecipe);
            console.log(img_url);
        } else {
            alert("Please select an Image and fill input  fields");
        }
        ...
        <>
            ...
            <div className="grid grid-cols-1  lg:grid-cols-2 auto-rows-max  ">
                <div className=" ...">
                    ...
                    <input  name="makeTime" type="text"  value={newrecipe.category} onChange={handleChange} className=" w-11/12 mb-2 px-3 py-2 mt-1 mb-3 border-2 rounded focus:outline-none placeholder:text-blue-300 border-neutral-400" placeholder="" />

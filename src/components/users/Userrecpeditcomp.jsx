    ...
    return (
        <>
            <div className=" py-5 items-end  w-11/12">
                <button onClick={() => { handlecancel(1) }} className="text-black py-2">
                    < BsFillArrowLeftCircleFill size={30} />
                </button>
            </div>
            <h1 className="my-5 font-semibold text-3xl" >Edit Recipe</h1>
            <div className="grid grid-cols-1  lg:grid-cols-2 auto-rows-max  ">
                <div className=" ...">
                    ...
                    <input name="makeTime" value={printdetails.makeTime} onChange={handleChange} min="0" type="text" className=" w-11/12 mb-2 px-3 py-2 mt-1 mb-3 border-2 rounded focus:outline-none placeholder:text-blue-300 border-neutral-400" placeholder="" />
